...
class Setting(db.Model):
    ...
    defaults = {
        ...
        'sudis_idp_url': 'http://idp.int.sudis.at-consulting.ru',
        'sudis_sso_url': 'http://idp.int.sudis.at-consulting.ru/idp/profile/SAML2/POSTGOST/SSO',
        'sudis_sls_url': 'http://idp.int.sudis.at-consulting.ru/idp/Logout?logoutRedirectUrl=http%3A%2F%2Flocalhost',
