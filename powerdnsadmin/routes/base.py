...
def handle_bad_request(e):
    return render_template('errors/400.html.jinja', code=400, message=e), 400
...
def handle_access_forbidden(e):
    return render_template('errors/403.html.jinja', code=403, message=e), 403


def handle_page_not_found(e):
    return render_template('errors/404.html.jinja', code=404, message=e), 404


def handle_internal_server_error(e):
    return render_template('errors/500.html.jinja', code=500, message=e), 500
